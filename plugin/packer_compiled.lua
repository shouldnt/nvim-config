...
_G.packer_plugins = {
  ...
  ["git.nvim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/git.nvim",
  ...
  ["gruvbox-material"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/gruvbox-material",
  ...
  ["markdown-preview.nvim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/markdown-preview.nvim",
  ...
  ["neovim-session-manager"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/neovim-session-manager",
  ...
  ["onedarkpro.nvim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/onedarkpro.nvim",
  ...
  ["prettier.nvim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/prettier.nvim",
    url = "https://github.com/MunifTanjim/prettier.nvim"
  },
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
  ...
  ["vim-commentary"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/vim-commentary",
    url = "https://github.com/tpope/vim-commentary"
  },
  ["vim-jsx-improve"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/vim-jsx-improve",
