    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader><leader>', function()
        ...
        require('telescope.builtin').find_files {
          cwd = get_git_root(),
          find_command = { 'fd', '--type', 'f', '-H', '--full-path', '--no-ignore', '--exclude', 'node_modules' },
        }
      end)
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { c = true, cpp = true, typescript = true, jsx = true, js = true, javascript = true, ts = true }
